 ...
 * @author geeo
 */
public class SalaFrameTest extends javax.swing.JFrame {
    ...
    public SalaFrameTest(String nomeDaConversa, long conversaId) {
        initComponents();
        /*
...
//ok
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaFrameTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalaFrameTest(nomeDaConversa, conversaId).setVisible(true);
            }
        });
    }
